...
function Access() {
  ...
  return (
    <div className='bg-[#EEEEEE]' >
      ...
      <input className='text-2xl mb-12 bg- rounded-lg p-1 text-[#0B2447] w-48' value={code} onChange={(e) => setCode(e.target.value)}></input>
      <button className=' text-slate-800 font-semibold text-2xl bg-slate-100 mx-10 rounded-lg p-1 w-28 shadow-xl' onClick={find}>Submit</button>
      </div>
     {
      text?(
        <div className='m'>
